                ...
                <tbody>
                    {
                        llistaCompres.map(p=>(
                            <tr key={p.id}>
                                ...
                                <td>{p.price}</td>
                                <td>
                                    <button className="btn btn-outline-primary" onClick={ () => disminuirQuantitat(p.id)}> - </button>
                                    <button className="btn btn-primary">{p.quantitat}</button>
                                    <button className="btn btn-outline-primary" onClick={ () => augmentarQuantitat(p.id)}> + </button>
                                </td>
                                <td>
                                    <button className="btn btn-danger"
                                    onClick={()=> eliminarCompra(p.id)}>Esborrar</button>
                                </td>
                            </tr>
                        ))
                    }
